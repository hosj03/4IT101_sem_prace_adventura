...
public class HerniPlan {
    ...
    private void zalozProstoryHry() {
        ...
        Vec raspberryPi = new Vec("raspberryPi", "malý \"počítač\"", false, false);
        ...
        Vec stulS = new Vec("stůl", "stůl v Securityho pokoji, na kterém se nachází arduino a raspberryPi", false,false);
        ...
        pokojSecurityho.pridejVec(raspberryPi);
    ...
    public String novyDen() {
        ...
        try {
            ...
            if (!seznamPostav[1].isMrtvy()) {
                ...
                Vec papir = new Vec("lístešek", "Lísteček na kterém je něco napsáno.", false, false);
